...
TARGET_OBJ := $(BUILDDIR)/$(MAINDIR)/main.o
TEST_TARGET_OBJ := $(BUILDDIR)/$(TESTDIR)/tests.o
...
test: dirs $(OBJS)
	@printf "\n\n\n########## LINKING OBJECTS ##########\n\n\n"
	$(HIDE)$(CXX) $(LDFLAGS) $(filter-out $(TARGET_OBJ), $(OBJS)) $(LDLIBS) -o $(TEST_TARGET)
	@printf "\n\n########## DONE ##########\n\n\n"

## Build the project
main: dirs $(OBJS)
	@printf "\n\n\n########## LINKING OBJECTS ##########\n\n\n"
	$(HIDE)$(CXX) $(LDFLAGS) $(filter-out $(TEST_TARGET_OBJ), $(OBJS)) $(LDLIBS) -o $(TARGET)
	@printf "\n\n########## DONE ##########\n\n\n"
