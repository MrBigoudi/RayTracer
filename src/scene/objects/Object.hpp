...
struct Object{
    ...
    */
    virtual maths::Vector3* doesRayIntersect(const maths::Ray & ray, int limit) const;
    ...
    */
    virtual bool isPointInObject(const maths::Vector3 & point) const;
    ...
    */
    virtual maths::Vector3* getNormal(const maths::Vector3 & point) const;
